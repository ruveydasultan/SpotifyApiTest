...
public class ListTest extends BaseServiceTest {
    ...
    @Test
    public void listCreateAndIsEmptyTest() throws IOException {
        ...
        String myPlayListId = playlistService.getCreatedPlayListId(playlistResponse);//Oluşturduğun playlistin Response modelinden playlist id'i al
    ...
    //    trackList.add(trackUri);

     // Map<String, Object> addItemsToPlayListParams = requestMaps.addItemsToPlaylistParamsMap(myPlayListId,trackUri);
